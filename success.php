...
<head>
    ...
    <!-- title -->
    <title>تنفيذ شيلات النجاح والتخرج</title>
...
<body class="abuot">
  ...
  <nav data-header>
    ...
    <!-- Navbar End -->
    <?php 
        $get_name_servise12 =$db->getData("services","*","id=12")
       ?>  
    <!-- section comment -->
    ...
    <h2 class="section__header1"><?php echo $get_name_servise12[0]['name']; ?></h2>
    <p>
    <?php echo $get_name_servise12[0]['article']; ?>
</p>
          <a href="./contact.php">
    ...
    <img src="./images_site/services/<?php echo $get_name_servise12[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
    </div>
  </div>
</secttion>
    ...
    <div id="video-container">
        ...
        <div id="video-list">
        <?php
                $videosData = $db->getData("services_videos", "urls_videos", "service_id=12");
                if (!empty($videosData)) {
