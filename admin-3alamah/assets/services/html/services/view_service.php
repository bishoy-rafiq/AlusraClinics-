                                    ...
                                    <div class="cart-items">
                                        <?php
                                            ...
                                            if (isset($_GET['id']) && is_numeric($_GET['id'])) {
                                                    $get_item = $db->getData("services", "*", "id=" . $_GET['id']);
                                                if ($get_item !== false && !empty($get_item)) {
                                                    $get_item = $get_item[0];
                                                    echo "<div class='cart-item'>";
                                                    echo "<h3> الصورة </h3><br/>";
                                                    echo "<img  width='50%' src='../../../../../images_site/services/" . $get_item['image'] . "' alt='صورة العنصر'>";
                                                    echo "<div class='item-details'>";
                                                    echo "<h3>  اسم الخدمة : </h3><p>" . $get_item['name'] . "</p>";
                                                    echo "<h3> الوصف</h3> <br/> <p>" . $get_item['description'] . "</p>";
                                                    echo "<h3> المقال</h3> <br/> <p>" . $get_item['article'] . "</p>";

                                            
                                                        $category_name = $db->get_data("categories", "name", "id=" . $get_item['category_id'] . "");
                                                        if ($category_name !== false) {
                                                            echo "<h3>الفئة: </h3> <p>" . $category_name[0]['name'] . "</p>";
                                                        } else {
                                                            echo "<h3>الفئة: </h3><p>غير موجودة</p>";
                                                        }
