...
$totalServicesCount = $db->get_data("categories", "COUNT(*) as total")[0]['total'];

$servicesPerPage = 5;
$totalPages = ceil($totalServicesCount / $servicesPerPage);
$currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
$startIndex = ($currentPage - 1) * $servicesPerPage;
$categories = $db->get_data("categories", "*", null, $currentPage);
...
<div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-list-alt me-2"></i>التصنيفات</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addCategory.php" class="dropdown-item"> اضافة تصنيف</a>
        ...
        <div class="content">
            ...
            if (isset($_SESSION["error_deleted_category"])) {
                echo $_SESSION["error_deleted_category"];
                unset($_SESSION["error_deleted_category"]); 
            }
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded p-4">
                            <div class="d-flex justify-content-center mb-1">
                                <a href="addCategory.php" class="btn btn-success">اضافة التصنيف</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bg-light rounded p-4">
                            ...
                            <table border="3" style="border-color: black;">
                                ...
                                foreach ($categories as $category) {
                                    ...
                                    echo "<td>
                                        <a href='editCategory.php?id=" . $category['id'] . "' class='view'>تعديل</a>
                                        <a href='../../../delete.php' class='delete' onclick='return confirmDelete(\"{$category['name']}\")'>حذف</a>
                                        </td>";
                                    echo "</tr>";
                                }
                                ?>
    ...
    function confirmDelete(categoryName) {
        if (confirm('هل أنت متأكد أنك تريد حذف الخدمة "' + categoryName + '"؟')) {
            window.location.href = '../../../delete.php?page=category&categoryName=' + encodeURIComponent(categoryName);
        }
        return false; 
    }
    </script>
