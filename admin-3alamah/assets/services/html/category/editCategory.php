                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded p-4">
                        <div class="d-flex justify-content-center mb-1">
                            <form action="../../../editbtn.php" method="post" enctype="multipart/form-data">
                                <label for="category_name"> اسم التنصيف </label>
                                <?php
                                        $category_id = $_GET['id'];
                                        $name_category = $db->get_data("categories","name","id=".$category_id);
                                    ?>
                                <input type="text" id="category_name" name="category_name"
                                    value="<?php echo $name_category[0]['name']?>" required />
                                <?php
                                ...
                                <div class="button-container mr-5 mt-2">
                                    <button type="reset" class="btn btn-warning m-1">إعادة تعيين</button>
                                    <button type="submit" class="btn btn-success m-1" name="category_edit"> تعديل
                                        التصنيف</button>
                                </div>
                            </form>
                        </div>
