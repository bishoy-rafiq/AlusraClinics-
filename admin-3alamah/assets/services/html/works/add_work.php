...
<head>
    <meta charset="utf-8">
    <title>اضافة تصنيف لتصميم الجرافكس</title>
...
<body>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="works.php" class="dropdown-item">قائمة التصنيفات</a>
                        </div>
                    </div>
                        ...
                        <div class="bg-light rounded p-4">
                                ...
                                <div class="col-sm-12 col-xl-12">
                                    <div class="bg-light rounded p-4">
                                        <div class="d-flex justify-content-center mb-1">
                                            ...
                                            <?php
                                            if(isset($_SESSION['error']['service_error']) && $errors_check) {
                            ...
                            <div class="row g-4" dir="rtl">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="bg-light rounded p-4">
                                        <div class="d-flex justify-content-center mb-1">
                                            <label for="work_image">صور التصنيف</label>
                                            <input type="file" id="work_image" name="work_image[]" accept="image/*" multiple required>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                                ...
                                <div class="col-sm-12 col-xl-12">
                                    <div class="bg-light rounded p-4">
                                        <div class="d-flex justify-content-center mb-1">
                                            ...
                                            <button type="submit"class="btn btn-success m-1" name="add_work"> إرسال</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- =================== Show images =================== -->
    <script>
        const workImageInput = document.getElementById('work_image');
