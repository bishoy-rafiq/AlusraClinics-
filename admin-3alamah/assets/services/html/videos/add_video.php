...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="#" class="dropdown-item"> اضافة فيديو</a>
                            <a href="videos.php" class="dropdown-item">قائمة الفيديوهات</a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded p-4">
                            ...
                            <form action="../../../btnSubmit.php" method="post" enctype="multipart/form-data">
                                <label for="youtube_link">رابط الفيديو على اليوتيوب</label>
                                <input type="text" id="youtube_link" name="youtube_link" placeholder="أدخل رابط الفيديو"/>

                                    <?php
                                        if(isset($_SESSION['error']['youtube_link_error'])) {
                                            echo $_SESSION['error']['youtube_link_error'];
                                            unset($_SESSION['error']['youtube_link_error']);
                                        }
                                    ?>
                                ...
                                <div class="col-sm-12 col-xl-12">
                                    <div class="bg-light rounded p-4">
                                        <div class="d-flex justify-content-center mb-1">
                                            ...
                                            <button type="submit"class="btn btn-success m-1" name="add_video"> إرسال</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../../js/view_video_upload.js"></script>
