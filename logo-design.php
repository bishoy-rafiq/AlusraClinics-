...
<head>
    ...
    <title>تصميم شعارات احترافية - تجسيد هوية علامتك التجارية</title>
<meta name="description" content="احصل على تصميم شعارات احترافية تمثل علامتك التجارية وتعكس رسالتك بوضوح واحترافية.">
    <!-- icon-logo -->
...
<!-- Navbar End -->
    ...
    <!-- section -->
    <?php 
        $get_name_servise8=$db->getData("services","*","id=8")
       ?>  
    <secttion class="story">
      <div class="section__container story__container">

        <div class="story__content">
        <h2 class="section__header1"><?php echo $get_name_servise8[0]['name']; ?></h2>
        <p>
    <?php echo $get_name_servise8[0]['article']; ?>
        ...
        <img src="./images_site/services/<?php echo $get_name_servise8[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
        </div>
      </div>
    </secttion>
    ...
    <h2 class="section__header1">المعرض</h2>
    <div class="swiper-container1">
        <div class="swiper-wrapper">
            <?php
            // جلب الصور من قاعدة البيانات
            $imageData = $db->getData("works", "*", "service_id=8 LIMIT 1"); // تحديد خدمة معينة
            if (!empty($imageData)) {
...
<div class="footer__bar"><a href="https://www.facebook.com/beshoyp0" class="footer-link">
    Copyright © 2024 Bishoy Rafiq. All rights reserved.</a>
  </div>
</footer>
<!-- زر WhatsApp -->
