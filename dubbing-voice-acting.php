...
<head>
    ...
    <title>خدمات دوبلاج وتمثيل صوتي احترافية - اجعل صوت علامتك يبرز</title>
    <meta name="description" content="احصل على خدمات دوبلاج وتمثيل صوتي احترافية تنقل رسالتك بوضوح وتبث الحياة في مشروعك. نحن نقدم أداء صوتي مميز بلغات متعددة يلائم احتياجات علامتك التجارية.">
...
<!-- Navbar End -->
    ...
    <!-- section -->
    <?php 
        $get_name_servise4=$db->getData("services","*","id=4")
       ?>  
    <secttion class="story">
      <div class="section__container story__container">

        <div class="story__content">
        <h2 class="section__header1"><?php echo $get_name_servise4[0]['name']; ?></h2>
        <p>
        <?php echo $get_name_servise4[0]['article']; ?>
      </p>
          <a href="./contact.php">
        ...
        <img src="./images_site/services/<?php echo $get_name_servise4[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
    ...
    <div id="video-container">
        ...
        <div id="video-list">
        <?php
                $videosData = $db->getData("services_videos", "urls_videos", "service_id=4");
                if (!empty($videosData)) {
