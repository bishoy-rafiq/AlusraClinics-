...
<head>
    ...
    <!-- title -->
    <title>تنفيذ شيلات الزفاف والأعراس</title>
    <meta lang="ar" name="description" content="علامة - نصنع التميز والنجاح لعلامتك التجارية. نقدم جميع خدمات السوشال ميديا بأفضل الأسعار وأقوى العروض، بما في ذلك: فيديوهات الموشن جرافيك، مونتاج الفيديوهات، التعليق الصوتي، التصميم الجرافيكي، صناعة المحتوى وإدارة صفحات السوشال ميديا، وتنفيذ الزفات والشيلات حسب الطلب (زفات وشيلات الخطوبة والزفاف، شيلات النجاح والتخرج، شيلات اعياد الميلاد والمولود الجديد)." />
...
<body class="abuot">
  ...
  <nav data-header>
    ...
    <!-- Navbar End -->
    <?php 
        $get_name_servise13 =$db->getData("services","*","id=13")
       ?>  
    <!-- section comment -->
    ...
    <h2 class="section__header1"><?php echo $get_name_servise13[0]['name']; ?></h2>
    <p>
    <?php echo $get_name_servise13[0]['article']; ?>
</p>
          <a href="./contact.php">
    ...
    <img src="./images_site/services/<?php echo $get_name_servise13[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
    </div>
  </div>
</secttion>
    ...
    <div id="video-container">
        ...
        <div id="video-list">
        <?php
                $videosData = $db->getData("services_videos", "urls_videos", "service_id=13");
                if (!empty($videosData)) {
