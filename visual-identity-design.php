...
<head>
    ...
    <title>تصميم الهوية البصرية - صورة تعبر عن قيمتك</title>
<meta name="description" content="ابتكر هوية بصرية فريدة تعكس قيمك وتساعدك في التميز في السوق وزيادة ولاء العملاء.">
...
<?php 
        $get_name_servise7=$db->getData("services","*","id=11")
       ?>  
<secttion class="story">
    ...
    <h2 class="section__header1"><?php echo $get_name_servise7[0]['name']; ?></h2>
    <p>
    <?php echo $get_name_servise7[0]['article']; ?>
  </p>
      <a href="./contact.php">
    ...
    <img src="./images_site/services/<?php echo $get_name_servise7[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
    </div>
  </div>
</secttion>
...
<h2 class="section__header">المعرض</h2>
    <div class="swiper-container1">
        <div class="swiper-wrapper">
            ...
            $imageData = $db->getData("works", "*", "service_id=11 LIMIT 1"); // تحديد خدمة معينة
            if (!empty($imageData)) {
