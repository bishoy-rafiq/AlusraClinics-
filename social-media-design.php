...
<head>
    ...
    <title>تصاميم السوشال ميديا - جذب الانتباه والتفاعل</title>
<meta name="description" content="احصل على تصاميم سوشال ميديا مبتكرة تعزز وجودك الرقمي وتجذب انتباه جمهورك على مختلف المنصات.">
...
<?php 
        $get_name_servise11=$db->getData("services","*","id=7")
       ?>  
     <!-- section -->
    <secttion class="story">
      <div class="section__container story__container">
        ...
        <h2 class="section__header1"><?php echo $get_name_servise11[0]['name']; ?></h2>
        <p>
        <?php echo $get_name_servise11[0]['article']; ?>
        </p>
        <a href="./contact.php">
        ...
        <img src="./images_site/services/<?php echo $get_name_servise11[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
        </div>
      </div>
    </secttion>
    ...
    <div class="swiper-container1">
        <div class="swiper-wrapper">
            ...
            $imageData = $db->getData("works", "*", "service_id=12 LIMIT 1"); // تحديد خدمة معينة
            if (!empty($imageData)) {
