...
<head>
    ...
    <!-- title -->
    <title>تصميم موشن جرافيك - إبداع وجاذبية في كل حركة</title>
<meta name="description" content="استمتع بتصميم موشن جرافيك احترافي لجعل محتواك أكثر جذبًا وإبداعًا مع الرسوم المتحركة المبهرة.">
    <!-- icon-logo -->
...
<body class="abuot">
  ...
  <nav data-header>
    ...
    <?php 
        $get_name_servise2=$db->getData("services","*","id=2")
       ?>  
    <secttion class="story">
      <div class="section__container story__container">

        <div class="story__content">
          <h2 class="section__header1"><?php echo $get_name_servise2[0]['name']; ?></h2>
          <p><?php echo $get_name_servise2[0]['article']; ?></p>
          <a href="./contact.php">
        ...
        <img src="./images_site/services/<?php echo $get_name_servise2[0]['image']; ?>" alt="مونتاج وتعديل الفيديوهات" class="w-100 rounded-5" />
    ...
    <div id="video-container">
        ...
        <div id="video-list">
        <?php
                $videosData = $db->getData("services_videos", "urls_videos", "service_id=2");
                if (!empty($videosData)) {
